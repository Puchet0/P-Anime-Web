...
export function AnimePage() {
  ...
  const toggleFavorite = async () => {
    ...
    if (isFav) {
      ...
      addLocalFavorite({ url: stableId, title: anime.title, image: anime.image, addedAt: new Date().toISOString(), malId: anime.malId, anilistId: anilistQuery.data?.id });
    }
  };
              ...
              <div className="mb-8">
                ...
                <p
                  ...
                  dangerouslySetInnerHTML={{
                    __html: sanitizeHtml(anime.anilistFullDescription || anime.description || ''),
                  }}
                />
              </div>
            )}
